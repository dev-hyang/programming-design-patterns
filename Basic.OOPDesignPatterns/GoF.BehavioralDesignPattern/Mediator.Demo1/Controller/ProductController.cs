...
namespace CQRSAndMediatrSampleApi.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([FromBody] ProductDto product)
        {
            ...
            // Notify consumers
            await _mediator.Publish(new PublishProductEvent() { Message = $"Product {product.Sku} created" });
        ...
        public async Task<IActionResult> Update([FromBody] ProductDto product)
        {
            ...
            // Notify consumers
            await _mediator.Publish(new PublishProductEvent() { Message = $"Product {product.Sku} updated" });
        ...
        public async Task<IActionResult> Remove(string productSku)
        {
            ...
            // Notify consumers
            await _mediator.Publish(new PublishProductEvent() { Message = $"Product {productSku} removed" });
        ...
        {
            await _mediator.Publish(new PublishProductEvent() { Message = message });
            return Ok();
        }
    }
}